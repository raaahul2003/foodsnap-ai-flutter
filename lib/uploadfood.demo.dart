...
//     return Scaffold(
//       appBar: AppBar(
//         title: const Text("Snap Your Foods"),
//         centerTitle: true,
//       ),
...
//           Row(
//             children: [
//               _macroCard("Protein", protein, Colors.blue),
//               const SizedBox(width: 10),
//               _macroCard("Carbs", carbs, Colors.orange),
//               const SizedBox(width: 10),
//               _macroCard("Fat", fat, Colors.red),
//             ],
//           ),
//
//           const SizedBox(height: 25),
